...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-midnight/95 backdrop-blur-sm p-4">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button
            onClick={accept}
            className="px-4 py-2 text-sm font-semibold bg-amber text-midnight rounded hover:bg-amber-dark transition-colors"
          >
            Accept
          </button>
        </div>
